...
exports.schedule = function (mongoose) {
...
exports.month_schedule = function (mongoose) {
	return function (req, res) {
...
exports.create_shift = function (mongoose) {
	return function (req, res) {
...
exports.delete_shift = function (mongoose) {
	return function (req, res) {
		var Shift = mongoose.model('Shift');
		Shift.findOne({
...
exports.update_shift = function (mongoose) {
	return function (req, res) {
		var Shift = mongoose.model('Shift');
		Shift.update(
			{ _id: mongoose.Types.ObjectId.fromString(req.params.shift_id) },
...
exports.get_shift = function (mongoose) {
	return function (req, res) {
		var Shift = mongoose.model('Shift');
